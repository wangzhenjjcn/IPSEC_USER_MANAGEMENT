...
public class TunnelServiceTest {
	...
	@Test
	public void testPostConnectPacket() throws JSONException   {
	...
	@Test
	public void testPostClosePacket() throws JSONException  {
		HttpMock httpMock = helper.createTunnelHttpMock("POST");
		httpMock.setRequestBody(helper.buildPacket(new JSONObject()
			.put("type", "close")
			.put("tunnelId", "tunnel1")
	...
	@Test
	public void testPostMessagePacket() throws JSONException  {
		HttpMock httpMock = helper.createTunnelHttpMock("POST");
		httpMock.setRequestBody(helper.buildPacket(new JSONObject()
			.put("type", "message")
			.put("tunnelId", "tunnel1")
	...
	@Test
	public void testPostUnknownMessagePacket() throws JSONException  {
		HttpMock httpMock = helper.createTunnelHttpMock("POST");
		httpMock.setRequestBody(helper.buildPacket(new JSONObject()
			.put("type", "message")
			.put("tunnelId", "tunnel1")
	...
	@Test
	public void testPostUnknownPacket() throws JSONException   {
		HttpMock httpMock = helper.createTunnelHttpMock("POST");
		httpMock.setRequestBody(helper.buildPacket(new JSONObject()
			.put("type", "unknown")
			.put("tunnelId", "tunnel1")
	...
	@Test
	public void testPostPacketWithErrorSignature() throws JSONException   {
		HttpMock httpMock = helper.createTunnelHttpMock("POST");
	...
	@Test
	public void testPostBadRequest() throws JSONException    {
		HttpMock httpMock = helper.createTunnelHttpMock("POST");
